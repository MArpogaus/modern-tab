...
[[https://github.com/MArpogaus/modern-tab/graphs/contributors][https://img.shields.io/github/contributors/MArpogaus/modern-tab.svg?style=flat-square]]
[[https://github.com/MArpogaus/modern-tab/network/members][https://img.shields.io/github/forks/MArpogaus/modern-tab.svg?style=flat-square]]
[[https://github.com/MArpogaus/modern-tab/stargazers][https://img.shields.io/github/stars/MArpogaus/modern-tab.svg?style=flat-square]]
[[https://github.com/MArpogaus/modern-tab/issues][https://img.shields.io/github/issues/MArpogaus/modern-tab.svg?style=flat-square]]
[[https://github.com/MArpogaus/modern-tab/blob/main/COPYING][https://img.shields.io/github/license/MArpogaus/modern-tab.svg?style=flat-square]]
[[https://github.com/MArpogaus/modern-tab/actions/workflows/test.yml][https://img.shields.io/github/actions/workflow/status/MArpogaus/modern-tab/test.yml.svg?branch=main&label=tests&style=flat-square]]
...
carries that name as its prefix; so does the repository.  Both modes
are autoloaded, so nothing needs requiring:
...
| =modern-tab-line-active-indicator-width=    | ~2~, in pixels       |
| =modern-tab-line-inactive-indicator-width=  | ~1~, in pixels       |
...
fallback, and =modern-tab-icon-for= keeps the answer under the spec it
was given — a string stands for itself, a plist names a nerd icon, and
a function is called once for the string it returns:

#+begin_src emacs-lisp
  (defun my/tab-icon (buffer)
    (modern-tab-icon-for (if (buffer-modified-p buffer) "● " "  ")))

  (setopt modern-tab-line-icon-function #'my/tab-icon)
#+end_src

The spec is the key, so hand it a value and not a closure built on the
spot: a fresh function every call is a fresh question every call.
...
[[https://github.com/MArpogaus/modern-tab/issues][issues page]] or submit a [[https://github.com/MArpogaus/modern-tab/pulls][pull request]].
...
Project Link: [[https://github.com/MArpogaus/modern-tab][https://github.com/MArpogaus/modern-tab]]
